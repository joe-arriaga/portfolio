...
public class ESConsumerBatching {
    ...
    public static void main(String[] args) throws IOException {
        Logger logger = LoggerFactory.getLogger(ESConsumerBatching.class.getName());
        ...
        while(true){
            ...
            for (ConsumerRecord<String, String> record : records){
                ...
                try {
                    ...
                    bulkRequest.add(indexRequest); // add individual requests(records) to batch
                                               // fast, just CPU work, no network transmission
